...
I study Computer Science and build practical IT projects around web development, automation, cybersecurity, and local-first software.
...
- Automation with Python, JavaScript, shell scripts, and small internal tools
- Local-first productivity software
...
University-related work around Zero Trust architecture and anomaly detection.
...
- Practical documentation for technical teams

## Tech stack and tools

I work with and learn around:

```txt
Languages:      Python, JavaScript, TypeScript, Swift, Bash
Web:            HTML, CSS, Tailwind, React, Astro
Data:           pandas, CSV, Excel, Parquet basics
Tools:          Git, GitHub, GitLab, VS Code, Xcode, Docker basics
Systems:        macOS, Windows, Linux basics
Interests:      Automation, local-first apps, cybersecurity, developer tooling
```

## How I think about software

I prefer building in small, understandable steps.

Good software should be:

- Clear before clever
- Documented enough to continue later
- Safe around user data
...
| Web development | Portfolio sites, landing pages, responsive UI, technical presentation |
| Automation | Small scripts, workflow simplification, repetitive task reduction |
| Cybersecurity | Zero Trust architecture, policy enforcement, anomaly detection |
| Documentation | Project structure, READMEs, GitLab/GitHub workflows, technical notes |
...
Website: [sanlytech.de](https://sanlytech.de)

Email/contact form: `info@sanlytech.de`

---

This profile is a work in progress. I use it as a technical log of what I build, learn, and improve over time.
